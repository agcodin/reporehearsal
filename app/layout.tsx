...
export const metadata: Metadata = {
  ...
  icons: { icon: "/rr-logo.png", apple: "/rr-logo.png" },
    ...
    <html lang="en">
      <body className={`${mono.variable} ${sans.variable}`}>
        ...
        <header className="site-header">
          <Link className="brand" href="/" aria-label="RepoRehearsal home"><span className="brand-mark"><img className="brand-logo" src="/rr-logo.png" alt="" /></span><span>RepoRehearsal</span></Link>
