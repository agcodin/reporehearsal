...
export default function Landing() {
  return <main>
    ...
    <section className="trust-strip"><span>Languages</span><b>JavaScript</b><b>Python</b><b>Java</b><b>C / C++</b><b>C#</b><b>Go</b><b>Rust</b></section>
    <section className="daily-home page-pad"><div><span>Same challenge. Same clock. Every day.</span><h2>Repository of the Day</h2><p>Solve the shared five-file incident, then send your score and completion time to friends.</p></div><Link className="button button-dark" href="/daily">Open today’s challenge</Link></section>
