...
export default function Landing() {
  ...
  return <main>
    <section className="daily-home page-pad"><div className="daily-home-title"><span>Today · {challenge.dateKey}</span><h2>Challenge of the Day</h2><p>One shared repository. One shared incident. Compare a verified score and completion time with everyone playing today.</p></div><div className="daily-home-issue"><span>Today’s issue</span><b>{challenge.incident.name}</b><p>{challenge.incident.summary}</p></div><dl><div><dt>Files</dt><dd>{challenge.fileCount}</dd></div><div><dt>Time</dt><dd>{challenge.timeLimitMinutes} min</dd></div><div><dt>Level</dt><dd>{challenge.difficulty.toLowerCase()}</dd></div></dl><Link className="button daily-home-button" href="/daily">Play today’s challenge →</Link></section>
    ...
    <section className="trust-strip"><span>Supported languages</span><b>TypeScript</b><b>JavaScript</b><b>Python</b><b>Java</b><b>C</b><b>C++</b><b>C#</b><b>Go</b><b>Rust</b><b>Ruby</b><b>PHP</b><b>Kotlin</b><b>Swift</b><b>Scala</b></section>
