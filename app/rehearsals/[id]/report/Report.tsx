...
export default function Report({ sessionId }: { sessionId: string }) {
  ...
  async function shareResult() {
    ...
    const text = `${daily ? "Repository of the Day" : "RepoRehearsal"}: ${report.score}/100 in ${minutes}:${String(seconds).padStart(2, "0")}. Think you can beat it?`;
