...
export default function Repositories() {
  return <main className="app-page">
    <div className="page-title-row"><div><p className="eyebrow">REPOSITORIES</p><h1>Choose a codebase</h1><p>Start with the demo, paste a public GitHub link, or select code from your computer. No account is required.</p></div></div>
    ...
    <div className="repository-source-grid"><GitHubImportCard /><LocalUploadCard /></div>
  </main>;
}
