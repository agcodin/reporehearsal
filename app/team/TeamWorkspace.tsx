...
export default function TeamWorkspace() {
  ...
  return <main className="app-page team-dashboard">
    ...
    {error && <div className="team-error" role="alert">{error}</div>}
    <nav className="team-section-nav" aria-label="Team dashboard sections"><a href="#members">Members</a><a href="#assignments">Assignments</a><a href="#analytics">Analytics</a><a href="#results">Results</a><Link href="/team/studio">Incident studio</Link><Link href="/recruiting">Candidate screens</Link></nav>
