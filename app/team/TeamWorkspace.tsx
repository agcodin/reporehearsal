...
export default function TeamWorkspace() {
  ...
  return <main className="app-page"><div className="page-title-row"><div><p className="eyebrow">TEAM READINESS</p><h1>Reliability practice program</h1><p>Create assignments now. Member invitations and billing will connect after the preview period.</p></div><span className="badge badge-green">TEAM PREVIEW ACTIVE</span></div>
