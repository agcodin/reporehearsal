...
export type AccountRehearsal = { id: string; incidentTemplateId: string; incidentName: string; repositoryName: string; mode: AccountMode; status: "COMPLETED" | "UNRESOLVED"; score: number; durationMinutes: number; hintsUsed: number; completedAt: string; breakdown?: SkillBreakdownItem[] | null; category?: IncidentCategory | null };
