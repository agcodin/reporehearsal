...
export type MutationKind = "container-host" | "nullable-value" | "response-guard" | "environment-fallback" | "package-script";
...
function sourceFile(file: WorkspaceFile) { return /\.(?:cjs|js|jsx|mjs|ts|tsx)$/.test(file.path) && file.content.length <= 500_000; }
